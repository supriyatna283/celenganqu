    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col">
      ...
      <header className="border-b border-slate-800 bg-slate-900/50 backdrop-blur px-6 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-[#1A56A0] rounded-xl flex items-center justify-center">
      ...
      <main className="flex-1 p-8 max-w-4xl mx-auto w-full flex flex-col justify-center items-center text-center">
        <div className="bg-slate-900/60 border border-slate-800 p-8 rounded-3xl shadow-xl w-full max-w-lg backdrop-blur-xl">
          <div className="w-20 h-20 bg-[#1A56A0]/10 text-[#D6E4F7] rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-slate-800 pt-6">
            <div className="bg-slate-950/50 p-4 rounded-2xl border border-slate-800/80">
              ...
              <span className="text-lg font-bold text-[#D6E4F7]">{user.currency}</span>
            </div>
            <div className="bg-slate-950/50 p-4 rounded-2xl border border-slate-800/80">
          ...
          <div className="mt-8 bg-[#1A56A0]/10 border border-[#1A56A0]/20 text-[#D6E4F7] p-4 rounded-2xl text-sm">
