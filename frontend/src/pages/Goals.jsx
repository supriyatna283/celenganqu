                    ...
                    <div className="mt-8 space-y-2">
                      ...
                      <div className="w-full h-2.5 bg-slate-100 dark:bg-slate-950 rounded-full overflow-hidden shadow-inner">
                        <div
                          ...
                          style={{
                            width: `${percent}%`,
                            backgroundColor: g.color || '#2BBF4B'
                          }}
                        >
                  ...
                  <div className="mt-8 pt-5 border-t border-slate-100 dark:border-slate-800/50">
                    {g.is_completed ? (
                      ...
                      <button
                        ...
                        style={{ backgroundColor: g.color || '#2BBF4B', boxShadow: `0 10px 15px -3px ${g.color}30, 0 4px 6px -4px ${g.color}20` }}
                      >
            ...
            <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl relative max-h-[90vh] flex flex-col overflow-y-auto">
              ...
              <form onSubmit={handleSubmitGoal} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-gradient-primary text-white py-3 rounded-xl font-semibold shadow-lg shadow-primary/20 flex items-center justify-center mt-6 disabled:opacity-50 space-x-2 transition-all hover:brightness-110"
                >
                  {submitting ? (
                    <>
